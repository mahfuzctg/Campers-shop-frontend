...
const ContactUs = () => {
  return (
    <section className="container p-5   rounded-xl flex flex-col lg:flex-row items-center justify-between gap-5 w-full mx-auto ">
      <div className="flex-1 lg:w-[45%] space-y-4">
        <h2 className="text-3xl lg:text-5xl font-bold text-orange-500">
          CONTACT US
        </h2>
        <h2 className="text-3xl lg:text-5xl text-gray-600">TODAY</h2>
        <p className="text-gray-600 font-roboto">
          Have a question or feedback? Reach out to us, and we’ll make sure to
          respond as soon as possible.
        </p>
        <div className="flex items-center gap-4">
          <Link to="https://web.facebook.com/" className="text-blue-600">
            <svg
          ...
          <Link to="https://www.instagram.com/" className="text-purple-600">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="fill-current h-8 w-8"
          ...
          <Link to="https://www.linkedin.com/" className="text-blue-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="fill-current  h-8 w-8"
      ...
      {/* image card */}
      <div className="flex-1 bg-transparent w-full lg:w-[45%]">
        <img
          className="w-full bg-transparent h-auto rounded-lg"
          src={contactImage}
          alt="Contact Us"
        />
      </div>
